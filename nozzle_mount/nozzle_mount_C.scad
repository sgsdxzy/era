...
module nozzle_mount_C(){
    difference(){
        ...
        translate([9,-5,16])rotate([90,0,0])hole_threaded("M6",l=20,cltd=clearance);
        translate([31,-5,16])rotate([90,0,0])hole_threaded("M6",l=20,cltd=clearance);
    }
}
