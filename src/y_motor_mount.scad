...
{  
    difference(){
        union(){
            translate([0,20+38,0])nema17_mount(h=20);
            translate([-42.3/2,20,0])cube([42.3,16.85,26]);
            translate([42.3/2,20,0])cube([10,6,20]);
            translate([-42.3/2-10,20,0])cube([10,6,20]);
            difference(){
                translate([-42.3/2,0,20])cube([42.3,20,6]);
                translate([30,20+42.3/2,3])cube([42.3,42.3,6],center=true);
                translate([-13,10,30])hole_through("M4",l=10, cld=clearance);
                translate([13,10,30])hole_through("M4",l=10, cld=clearance);
            }              
        }
