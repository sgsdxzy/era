...
// Extrusion head
translate([-100,30,360])cube([40,20,40]);
translate([-140,60,366])cube([20,40,40]);
translate([-100,60,310])cube([40,40,90]);
...
translate([0,300,390])rotate([0,90,0])color("White",1)cylinder(d=8,h=300,center=true);
translate([130,10,376])rotate([-90,0,0])color("White",1)cylinder(d=8,h=320);
translate([-130,10,376])rotate([-90,0,0])color("White",1)cylinder(d=8,h=320);
